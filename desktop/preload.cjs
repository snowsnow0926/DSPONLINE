...
const NATIVE_CORE_TRANSFER_PROJECTION_TYPES = Object.freeze([
  "viewport-v1", "viewport-v2", "factory-read-model-v1", "factory-inventory-v1", "construction-inventory-v1", "construction-placement-context-v1", "construction-removal-context-v1", "statistics-v1", "technology-v1",
