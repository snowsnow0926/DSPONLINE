...
> 文档日期：2026-08-27  
> 文档角色：Feedback / architecture planning  
> 基线工作树：`D:\GameDev\DSPidle2-v123-windows-native-performance`  
> 基线提交：`9778ba4`，运行时代码提交 `6cdd86e7675d95da9834f3592b1d4c980830506e`  
> 当前候选：`1.2.3+6cdd86e7675d`，未签名、未部署、`authorityEligible=false`  
...
| 当前原生一秒精确推进 | 5,854 ms |
| 同次 JavaScript 一秒推进 | 9,686.3 ms |
| 当前原生局部增益 | 约 1.65 倍，重复样本约 1.65～2.20 倍 |
| 变化线路 | 140,023，约占 89.9% |

这份存档属于稠密活动网络。1.2.3 的活动队列会正确退化为全扫描，因此继续微调“休眠线路跳过比例”不能得到实时模拟所需的约 5.9 倍额外收益。
...
| --- | ---: | ---: |
| 1 秒推进 1 个模拟秒 | 约 5.85 倍 | 约 9.69 倍 |
| 1 秒推进 2 个模拟秒 | 约 11.71 倍 | 约 19.37 倍 |
| 15× 全逐秒精确时间扭曲 | 约 87.81 倍 | 约 145.29 倍 |
...
- **Reproduction or observed evidence：** 80,674 实体、155,746 线路、每模拟秒 311,492 路线方向检查；原生 5,854 ms/模拟秒，JS 9,686.3 ms/模拟秒；组合峰值约 4.90 GB
...
- 本计划仍是规划文档，不表示对应代码、安装包、签名、24 小时门禁或发布已经完成。
