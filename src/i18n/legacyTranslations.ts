...
const UI_EN: TranslationMap = {
  ...
  "指针与节点移动；WASD 平移视野": "Pointer and node movement; WASD pans the view",
  "同时选中生产区域": "Include production regions",
  "框选完整覆盖生产区域后，拖动选中节点可一起移动区域；区域边界仍可单独调整": "Fully enclose regions in the selection box to move them with selected nodes; resize boundaries separately",
  "选中区域与内部节点": "Select region and enclosed nodes",
  "选中区域与内部节点，拖动节点即可一起移动": "Select this region and enclosed nodes, then drag a selected node to move them together",
  "该生产区域内没有完整包含的可移动节点": "This region does not fully enclose any movable nodes",
  "框选模式": "Selection Mode",
