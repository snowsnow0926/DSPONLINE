...
> **1.2.6 最终发布候选（2026-08-31，未部署）**：固定 runtime `df828869e276e5d3a67513095a4d1c93d13c500f`，Release ID `1.2.6-df828869e276`。产率复制只直结白矩阵科研与逐恒星系戴森终端，不向量子仓库或其他库存复制物品；星图新增三次确认的一键重置星球工厂。typecheck、版本、许可证、生产审计、Rust fmt/clippy 通过；Vitest **1,719/29**，server **385/2 + 4/4**，Ops **56/6**，release-switch **29/29**，native **182/1**，Rust **222/222**。Chromium 435 个有效用例全部通过，其中主轮 2 个并发超时在单 Worker 隔离重跑 2/2；durable **7/7**、production preview **3/3**。44.5 MB 真实终局档完成 30 天 15× 结算并规范重载，源档不变。Android `1.2.6 / 1002006` 长期证书包、Windows `NotSigned` stable 包和 12 件不可变 bundle 已生成；candidate aggregate 为 `56e07009689a3c66f8f39178a9e0aa0e1bb61167be728663e6e8920555aad868`，六归档、provenance 3/3、SHA256SUMS 20/20 均复验。尚缺 Android 实体设备、三档 Windows、Windows 1.2.5→1.2.6 覆盖升级和长时运行，完成或由用户针对精确 Release ID 明确接受风险前不得连接生产。详见 [候选记录](./releases/1.2.6-candidate.md) 与 [发布交接](./RELEASE_HANDOFF_1.2.6.md)。
