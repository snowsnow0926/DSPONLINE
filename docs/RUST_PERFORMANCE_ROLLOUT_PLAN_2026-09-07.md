...
- 2026-09-08 发布后重启开发：共享保存、导入、离线准备和挂机恢复修复已随 1.2.7 网页/安卓上线；Rust 跨端与实时权威没有开放。已生成 [进度报告](./RUST_PROGRESS_REPORT_2026-09-08.md)，从已合入的 `9f4ac5c3` 继续 RP1，本轮先验证统计历史有序追加能否减少长离线重建成本。阶段内核数字和正式平台交付必须分别记账。
