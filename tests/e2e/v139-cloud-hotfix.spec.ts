...
test("reports the 1.2.5 candidate version and a unique build id", async ({ page }) => {
  ...
  expect(application.version).toBe("1.2.5");
  expect(application.build).toMatch(/^1\.2\.5\+[0-9a-f]{12}(?:\.dirty)?$/);
});
