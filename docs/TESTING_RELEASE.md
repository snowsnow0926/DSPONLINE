...
> **1.1.6 稳定发布验收已收口（2026-08-24）**：runtime SHA `4f6d24f8c709afc25c219665bbc0392244e05b64`。typecheck、Vitest 178 文件/1,462 passed/21 skipped、server 376/2、station 3/3、ops 56/6、native 25/25、Chromium 428 passed/26 skipped/0 failed、Web/Android build 和 startup budget、纯挂机真实 gzip 夹具均通过。candidate 11/11、provenance 3/3、SHA256SUMS 12/12，Web/API/native/download-site 组件清单复验通过；两地生产 health/ready、PWA 静态路由、下载 Range 和完整哈希也通过。Android 静态签名、v2/v3、zipalign、版本元数据与历史证书连续性通过，但本轮无实体 Android 设备，未将该门禁记为通过；Windows stable 继续明确为 `NotSigned`。详细证据见 [1.1.6 正式发布记录](./releases/1.1.6.md)，本段只记录实际观察，不替代后续候选的重新门禁。
