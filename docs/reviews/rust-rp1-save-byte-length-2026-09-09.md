...
> 后续从干净 37630d05 构建的新 Windows 包已冻结；终局完成入口仍超过 90 秒，但 9 秒完整 JS 对照、取消保档和取消后两次重开通过。7fd 云端构建、单元及 Linux Server/Ops/原生成功，完整浏览器 403/33 skip/29 unexpected/23 flaky；Windows Rust/Native 通过，游戏单元 3,169/39 skip/1 项矿脉长挂机超时。准确范围见[新包复验](./rust-rp1-private-cancel-2026-09-09.md)，下方保留此前保存专项时点事实。
