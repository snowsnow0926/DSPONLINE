...
import { getReleaseNotes127, getReleaseNotes128, getReleaseNotes129 } from "../i18n/releaseNotes";
...
const RELEASE_NOTES_1_1_6 = getReleaseNotes116("zh-CN");
...
const RELEASE_NOTES_1_2_0 = getReleaseNotes120("zh-CN");
...
const RELEASE_NOTES_1_2_5 = getReleaseNotes125("zh-CN");
const RELEASE_NOTES_1_2_6 = getReleaseNotes126("zh-CN");
...
const RELEASE_NOTE_ICONS: Record<string, LucideIcon> = {
  ...
  "real-save-memory-benchmark": Gauge,
  "memory-regression-gates": Check,
  "station-contract-id-repair": History,
  "station-contract-server-validation": ShieldCheck,
  "custom-building-trays": Database,
  "declarative-mod-contract": LockKeyhole,
  "contract-mod-regression": Check,
  "measured-belt-endpoints": Link2,
  "stable-dense-belt-topology": Gauge,
  "productive-pure-idle": Gauge,
  "dense-belt-regression": ShieldCheck,
  ...
  "v124-cloud-256m": CloudUpload,
  "v124-tab-takeover": LockKeyhole,
  "v124-content-family": Link2,
  "v124-endgame-replication": Gauge,
  "v124-compatibility-boundary": ShieldCheck,
};
...
export function ReleaseNotesDialog({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const localizedRelease125 = getReleaseNotes125(locale);
  const localizedRelease118 = getReleaseNotes118(locale);
  const localizedRelease117 = getReleaseNotes117(locale);
  const localizedRelease115 = getReleaseNotes115(locale);
  const localizedRelease126 = getReleaseNotes126(locale);
  ...
  const selectedRelease = selectedReleaseRecord.id === CURRENT_RELEASE_NOTES.id
    ...
    : selectedReleaseRecord.version === "1.2.9" ? getReleaseNotes129(locale)
    ...
    : selectedReleaseRecord.id === RELEASE_NOTES_1_1_7.id ? localizedRelease117
    : selectedReleaseRecord.id === RELEASE_NOTES_1_1_5.id ? localizedRelease115
