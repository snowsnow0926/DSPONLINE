...
> **Windows Rust 安装身份与终局测量（2026-09-10）**：身份/版别/制品专项 51 pass/1 权限 skip，5901 ASAR 语义差异已修正；新冻结 c9aa 实际 Electron 采集/助手复验通过，窗口/焦点 0。9e Windows 全套成功，Native 工具 851/1 skip、游戏 3,201/39 skip；终局三对完整导出一致、中位 49.90→49.02 秒但区间重叠。9e 浏览器一分片 241/11 skip/2 fail，另一分片初始化失败；完整入口及发布门禁仍未过，见[身份测试终态](./reviews/rust-windows-installed-program-2026-09-10.md)和[完整数值证据](./reviews/rust-rp1-canonical-buffer-2026-09-10.md)。
