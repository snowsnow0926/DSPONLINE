...
> **1.3.0 发布范围（2026-09-22）**：本次仅发布香港网页版，未构建、签名或发布新的 Android/Windows 安装器与 feed。源码包版本及 Android 版本属性已同步为 `1.3.0 / 1003000`，这是构建元数据，不代表原生下载已更新。原生公开版本仍沿用下方 1.2.9 发布记录；详情见 [香港 1.3.0](./releases/1.3.0.md)。
