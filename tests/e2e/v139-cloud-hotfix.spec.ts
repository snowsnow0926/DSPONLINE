...
test("reports the 1.1.2 candidate version and a unique build id", async ({ page }) => {
  ...
  expect(application.version).toBe("1.1.2");
  expect(application.build).toMatch(/^1\.1\.2\+[0-9a-f]{12}(?:\.dirty)?$/);
});
