...
describe("orbital station contracts", () => {
  ...
  it("does not regenerate settled deterministic offers on the same task day", () => {
    ...
    expect(new Set([
      ...sameDay.contractBoard.offers,
      ...sameDay.contractBoard.accepted,
      ...sameDay.contractBoard.history,
  ...
  it("repairs 1.1.0 same-day settled reoffers without losing history or reward fences", () => {
