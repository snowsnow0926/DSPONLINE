...
> **路线调整（2026-09-11）**：用户已放弃 Windows 本地版主导的计划。本文仅保留历史设计、实现和未完成门禁，不再作为当前主线或循环 Goal；Windows 代码、下载和存档兼容保持维护。当前执行入口是 [网页版优先开发计划](./WEB_FIRST_DEVELOPMENT_PLAN_2026-09-11.md)，Rust 资产按共享算法和潜在 Wasm 收益复用。
