...
test("reports the 1.1.9 candidate version and a unique build id", async ({ page }) => {
  ...
  expect(application.version).toBe("1.1.9");
  expect(application.build).toMatch(/^1\.1\.9\+[0-9a-f]{12}(?:\.dirty)?$/);
});
