...
> 2026-09-08 持续开发：物理签名、有序历史及冷开准入复用已取得局部收益。最新终局档冷开三对样本中，原生开档中位缩短 33.9%、Host 峰值私有提交减少 41.3%；完整 release Rust 1,351/5 ignored 通过，公共长离线两项超时正在独立复验。下一循环设计有界大厂证明和完整入口/取消/提交/重开验证。历史堆异常仅定位发现现场，根因仍未确认；不直接提高 2,000 记录上限，不把局部 RPC 收益当作 RP1 完成。见[冷开阶段证据](./reviews/rust-rp1-cold-open-admission-2026-09-08.md)。
