...
const UI_EN: TranslationMap = {
  ...
  "统计与运行记录": "Statistics & Activity Log",
  "教程、版本与其他": "Tutorial, Releases & More",
  "分类只影响本机设置页面的显示，不会改变存档内容；返回后会保留上次分类。": "Categories only organize settings on this device and never change save data. The last category remains selected when you return.",
  "设置分类总览": "Settings Category Overview",
  "亮色/深色、字体、语言和默认画布显示": "Light and dark themes, text size, language, and default canvas display",
  "刷新频率、极限模式与独立画布回退开关": "Refresh rate, extreme mode, and independent canvas fallback switches",
  ...
  "性能采样、运行记录和诊断报告": "Performance sampling, activity log, and diagnostic reports",
  "教程入口、版本记录、难度与社区": "Tutorial, release history, difficulty, and community",
  "主题快速设置": "Quick Theme Setting",
  "返回设置分类": "Back to Settings Categories",
  "显示运行记录": "Show Activity Log",
  "显示运行反馈浮条": "Show routine activity notices",
  "仅保留错误、成就和诊断": "Keep only errors, achievements, and diagnostics",
  ...
  "连接交互与批量建造更新": "Connection Controls & Batch Building Update",
  "1.0.27 增加连接点尺寸偏好、建筑制造批量目标和混合选区原子批量增加，并稳定移动端多选。GameState v46、存档 envelope v2 与云 schema v7 不变。": "Version 1.0.27 adds device-level connection-point sizing, batch construction targets, and atomic mixed-selection increases while stabilizing mobile multi-selection. GameState v46, save envelope v2, and cloud schema v7 are unchanged.",
  "连接点尺寸可调": "Adjustable Connection Point Size",
  "设置提供默认、放大 25% 和放大 50%；端口、连线圆圈、吸附半径与点击范围同步变化，并只保存在当前设备。": "Settings offers Default, +25%, and +50%. Ports, connection circles, snap radii, and hit targets scale together and are stored only on this device.",
  "建筑制造批量目标": "Batch Construction Targets",
  "建筑制造中心可一次为所有已解锁建筑设置库存目标；现有任务和在制品保持不变，并继续受仓储科技上限约束。": "The Construction Center can set one stock target for every unlocked building. Existing jobs and work in progress remain intact, and construction-capacity technologies still apply.",
  "混合选区批量增加": "Mixed-Selection Batch Increase",
  "建筑和传送带混合选区可使用 +1、+10、+100 或自定义数量；先汇总全部材料，缺料时整批保持不变。": "Mixed building and belt selections can use +1, +10, +100, or a custom amount. All materials are calculated first, and a shortage leaves the whole selection unchanged.",
  "移动端多选稳定性": "Stable Mobile Multi-Selection",
  "逐点多选在模拟刷新和画布事件重派生期间保留选区，持续显示选中轮廓和数量，不再因瞬时空选择被清除。": "Point-by-point selection now survives simulation refreshes and canvas event re-derivation, keeping selection outlines and counts instead of clearing on transient empty events.",
  "建筑连接点与连线圆圈": "Building Ports & Connection Circles",
  "视觉尺寸与点击范围同步": "Visual size and hit area stay aligned",
  "建筑连接点尺寸": "Building Connection Point Size",
  "放大 25%": "Increase 25%",
  "放大 50%": "Increase 50%",
  "端口、传送带端点和连接预览会一起放大；仅保存在本机，不进入存档。": "Ports, belt endpoints, and connection previews scale together. This preference stays on this device and is not saved with the game.",
  "全部建筑目标": "All Building Targets",
  "应用全部": "Apply to All",
  "全部建筑目标数量": "All Building Target Quantity",
  "批量设置建筑制造目标": "Set Construction Targets in Bulk",
  "亮色主题与设置交互更新": "Light Theme & Settings Interaction Update",
  "1.0.26 统一亮色与深色语义主题，重构设置分类和版本历史，并优化科技树滚轮与物品悬浮交互。GameState v46、存档 envelope v2 与云 schema v7 不变。": "Version 1.0.26 unifies light and dark semantic themes, restructures settings and release history, and improves technology-tree scrolling and item reference interactions. GameState v46, save envelope v2, and cloud schema v7 are unchanged.",
  "亮色与深色语义主题": "Semantic Light & Dark Themes",
  "工作区、节点、线路、弹窗、表单和移动界面统一使用语义颜色，补齐选中、禁用、危险、悬停和键盘焦点状态。": "Workspaces, nodes, belts, dialogs, forms, and mobile interfaces now share semantic colors with complete selected, disabled, danger, hover, and keyboard-focus states.",
  "设备级界面偏好": "Device-Level Interface Preferences",
  "主题、运行记录显示和设置分类只保存在当前设备；关闭普通运行记录时，必要错误与成就提示仍会显示。": "Theme, activity-log visibility, and settings category are stored only on this device. Essential errors and achievement notices remain visible when routine activity entries are hidden.",
  "设置分类与二级页面": "Settings Categories & Detail Pages",
  "设置首页改为清晰的分类总览，进入二级页面调整显示、操作和运行选项，返回后保留当前分类。": "The settings home is now a clear category overview with detail pages for display, controls, and runtime options, preserving the active category when returning.",
  "完整版本更新记录": "Complete Release History",
  "离线内置 1.0.0 至当前版本的分页记录，可查看每版详情；返回列表时保留页码和滚动位置。": "A paginated offline history from 1.0.0 through the current version provides per-release details and preserves page and scroll position when returning to the list.",
  "科技树滚轮横向浏览": "Horizontal Technology-Tree Scrolling",
  "科技树区域内的鼠标滚轮统一转换为横向移动，并阻止页面纵向滚动穿透，轨迹板横向输入继续自然生效。": "Mouse-wheel input inside the technology tree consistently pans horizontally and no longer leaks vertical scrolling to the page, while native trackpad horizontal input remains intact.",
  "物品悬浮与快捷操作": "Item Hover & Quick Actions",
  "物品卡缩小误触范围，并支持鼠标悬停、键盘焦点、移动端点击与长按；可直接定位产线或打开生产资料库。": "Item cards reduce accidental activation and support mouse hover, keyboard focus, mobile tap, and long press, with direct actions to locate production or open the Production Library.",
  "查看历史版本": "View Release History",
  "返回当前版本": "Return to Current Release",
  "上一页": "Previous",
  "下一页": "Next",
