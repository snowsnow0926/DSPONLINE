...
commands transactionally, replays verified `baseRevision -> resultRevision`
WAL operations, and emits canonical/component hashes for shadow comparison.
Unsupported replay domains fail without committing a partial command. Authority
promotion remains fail-closed until every simulation domain and the long-run
Gate C matrix report complete.
