...
function BuildingDetail({ readModel, buildingId, onSelectItem, onSelectTechnology }: {
  ...
  return <article className="codex-detail codex-building-detail">
    ...
    <dl className="codex-metrics">
      ...
      <div><dt>额定耗电</dt><dd>{building.powerDemandKw ? <PowerValue valueKw={building.powerDemandKw} /> : "无"}</dd></div>
      <div><dt>额定发电</dt><dd>{building.powerGenerationKw ? <PowerValue valueKw={building.powerGenerationKw} /> : "无"}</dd></div>
