...
test("reports the 1.2.4 candidate version and a unique build id", async ({ page }) => {
  ...
  expect(application.version).toBe("1.2.4");
  expect(application.build).toMatch(/^1\.2\.4\+[0-9a-f]{12}(?:\.dirty)?$/);
});
