...
> 当前生产状态（2026-08-29，1.2.4 已稳定发布）：香港/上海 Web/API current 均为 `1.2.4-3154f8cf4479`，Build ID `1.2.4+3154f8cf4479`；generation 46/30、proxy generation 183/86，均为 green / 4322。两地 release-control 直接 previous 为旧 `1.2.4-de5dcdb5ec6f`，但香港公开 `/canary/previous/` 已隔离指向稳定 `1.2.3-25aeeb34e501`，避免把缺失 PWA 注册的旧候选作为公开回退页。上海下载 current 为新候选、previous 为旧候选。两地 API/proxy/health/node-health 正常，香港 offsite timer active，`NRestarts=0`、pending 为空、health/ready 200；schema v8/layout v3 未变。发布前 Backup API evidence 为香港 4,191,731,712 B / `9410a741…`、上海 462,848 B / `08346312…`，均通过完整 SHA、`quick_check`、身份与独立 preflight；最终磁盘 78%/76%。Android `1.2.4 / 1002004` 保持长期证书，Windows 继续 `NotSigned`。完整证据见 [1.2.4 发布记录](./releases/1.2.4.md)。
